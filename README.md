<!DOCTYPE html>
<!-- saved from url=(0054)file:///C:/Users/USER/OneDrive/Desktop/html/index.html -->
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>SIRKACADEMY - JAMB UTME 2026 Examination Portal</title>
    <script src="./index_files_files/supabase-js@2"></script>
    <script src="./index_files_files/jspdf.umd.min.js.download"></script>
    <script src="./index_files_files/jspdf.plugin.autotable.min.js.download"></script>
    <link rel="stylesheet" href="./index_files_files/all.min.css">
    <style>
        :root {
            --primary: #1565C0;
            --primary-dark: #0D47A1;
    ...
    <div class="modal" id="editStudentModal">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button class="close-modal" onclick="closeModal(&#39;editStudentModal&#39;)">×</button>
            </div>
    ...
    <div class="modal" id="deleteConfirmModal">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button class="close-modal" onclick="closeModal(&#39;deleteConfirmModal&#39;)">×</button>
            </div>
